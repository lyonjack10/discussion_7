...
def find_strings_bet(string_list):
    """ Return a list of words that starts with letters B, E, or T from the list of strings. """
...
class TestAllMethods(unittest.TestCase):
    ...
    def test_find_bet(self):
        # read the lines from the file into a list of strings
        string_list = read_file('alice_ch_1.txt')
        bet_list = find_strings_bet(string_list)
        self.assertEqual(len(bet_list),34)
